...
$lang = array_merge($lang, array(
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Şifre en az %1$s uzunlukta olmalı, karışık durumda harfler ve sayılar içermelidir.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'En az %1$s uzunlukta olmalıdır.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Şifre en az %1$s uzunlukta olmalı ve karışık durumda harfler içermelidir.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Şifre en az %1$s uzunlukta olmalı, karışık durumda harfler, sayılar ve simgeler içermelidir.',	
	'PASSWORD'					=> 'Şifre',
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Kullanıcı adı %1$s ile %2$s arası uzunlukta olmalı ve sadece alfanümerik karakterler kullanılmalıdır.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'=> 'Kullanıcı adı %1$s ile %2$s arası uzunlukta olmalı ve alfanümerik, boşluk veya -+_[] karakterleri kullanılmalıdır.',
	'USERNAME_ASCII_EXPLAIN'		=> 'Kullanıcı adı %1$s ile %2$s arası uzunlukta olmalı ve ayrıca özel semboller olmadan sadece ASCII karakterler kullanılmalıdır.',
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'Kullanıcı adı %1$s ile %2$s arası uzunlukta olmalı ve sadece harf ya da sayı karakterleri kullanılmalıdır.',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'=> 'Kullanıcı adı %1$s ile %2$s arası uzunlukta olmalı ve harf, sayı, boşluk veya -+_[] karakterleri kullanılmalıdır.',
	'USERNAME_CHARS_ANY_EXPLAIN'	=> '%1$s ile %2$s arası uzunlukta olmalıdır.',
