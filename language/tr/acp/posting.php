...
$lang = array_merge($lang, array(
	...
	'BBCODE_DANGER'				=> 'Eklemeye çalıştığınız BBCode güvensiz görünüyor. Eğer BBCode, hassas bağlamda bir {TEXT} belirteci kullanıyorsa, bunun yerine daha kısıtlayıcı bir tür kullanmayı deneyin. Sadece, eğer söz konusu riskleri anladıysanız işleme devam etmek için ilerleyin.',
	...
	'BBCODE_INVALID_TEMPLATE'	=> 'BBCode’unuzun şablonu geçersiz.',
	'BBCODE_TAG'				=> 'Etiket',
	...
	'tokens'	=>	array(
		...
		'URL'			=> 'Herhangi bir izin verilen protokolde geçerli URL kullanımı (http, ftp, gibi… javascript exploitleri için kullanılamaz). Hiç biri verilmezse, diziye “http://” ön adı verilir.',
